...
export default function Home() {
  ...
  const featured = templates
    .filter((t) => t.statusBadge !== null)
    .sort((a, b) => BADGE_RANK[a.statusBadge!] - BADGE_RANK[b.statusBadge!])
    .slice(0, 4);
  ...
  return (
    <>
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto flex max-w-4xl flex-col items-center gap-6 px-5 py-24 text-center sm:px-8 sm:py-32">
